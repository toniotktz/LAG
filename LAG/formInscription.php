        ...
        <form action="pdo\ajoutInscription.php" method="post">
            <div class="row">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input type="text" class="form-control" id="ville" placeholder="Entrer la ville ou vous habitez" name="ville" required />

                    <label for="codePostal">Code postal:</label>
                    <input type="text" class="form-control" id="cp" placeholder="Entrer votre code postal" name="cp" required />

                    <label for="tel">Telephone:</label>
                    <input type="tel" class="form-control" id="telephone" placeholder="Entrer votre numero de telephone" name="telephone" required />
                </div>
            </div>
